...
open class Targets : Element(-46.0, -40.0, 1F, Side(Side.Horizontal.MIDDLE, Side.Vertical.MIDDLE)) {
    ...
    val rainbowOnHit = BoolValue("Tenacity-RainbowOnHit", true).displayable { modeValue.get().equals("TenacityNew", true) }
    ...
    private fun drawRiseNewNew(target: EntityLivingBase) {
        ...
        val additionalWidth = font.getStringWidth(target.name).coerceAtLeast(60) * 1.55f + 7f
